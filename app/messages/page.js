  ...
  return (
    <main className="min-h-screen bg-transparent px-3 py-4 text-slate-950 sm:p-6 md:p-8">
      <div className="mx-auto max-w-3xl">
        ...
        <section className="mb-3 rounded-2xl border border-blue-100 bg-blue-50 p-4 shadow-sm sm:p-5">
        ...
        {hasOpenRequest && <div className="mb-3 rounded-xl border border-amber-300 bg-amber-50 p-3 text-sm font-bold text-amber-900">You already have an open request.</div>}
        ...
        <form onSubmit={submit} className="rounded-2xl border border-slate-200 bg-white p-4 shadow-sm sm:rounded-3xl sm:p-7">
          <label className="block">
            ...
            <input required minLength={4} value={subject} onChange={(event) => setSubject(event.target.value)} placeholder="What do you need?" className="mt-1.5 h-11 w-full rounded-xl border border-slate-300 px-3 text-sm outline-none focus:border-blue-700" />
          </label>
