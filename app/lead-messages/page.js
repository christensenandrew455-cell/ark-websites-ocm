  ...
  return (
    <main className="min-h-screen bg-slate-50 px-3 py-4 text-slate-950 sm:p-6 md:p-8">
      <div className="mx-auto max-w-3xl">
        ...
        <header className="mt-6"><p className="text-[10px] font-black uppercase tracking-[0.2em] text-slate-500">{profile?.businessName || "ARK Client Center"}</p><h1 className="mt-1 text-4xl font-black tracking-tight">Messages</h1></header>
