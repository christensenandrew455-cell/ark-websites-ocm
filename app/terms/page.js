...
const sections = [
  ...
  },
  {
    ...
    body: <>
      ...
      <p><strong>Messages:</strong> When the owner enables Messages, $1 USD is charged once when each new chat is created. An existing chat is not charged another creation fee in a later period. After creation, inbound and outbound SMS parts are combined on one rolling counter, and $1 USD is charged each time that counter completes another 50 parts. Unfinished progress carries across billing periods, so 30 parts before a period plus 20 parts during it completes one charge in the later period. Long messages may use more than one SMS part.</p>
      <p><strong>Employees:</strong> When the owner enables Employees, $5 USD is charged for each approved employee account that is active at any time during the billing period. Pending employees are not charged. An employee active during a period remains chargeable for that period even if disabled or deleted later in it. An employee still active in the next period is charged again; an employee removed before the next period begins is not.</p>
      <p><strong>Recorded usage:</strong> Deleting a chat, message, lead, client, or employee record does not remove new-lead, chat-creation, completed SMS-part, or active-employee usage already incurred.</p>
      <p><strong>No included allowance:</strong> The account does not include free leads, chat creations, completed 50-part thresholds, or employee accounts. SMS-part charges begin when the rolling counter reaches 50 parts.</p>
      <p><strong>What counts as a lead:</strong> Each newly received estimate request or other connected intake submission creates one durable lead event. Moving, editing, assigning, retaining, or deleting that lead does not create another charge or erase the original event. Existing leads from an earlier period do not count again solely because they remain in the account. Duplicate events caused solely by a verified system error may be corrected by ARK.</p>
      <p><strong>Referrals:</strong> When a new paid owner account enters an eligible referring account ID and activates, the referring account receives 10% off one billing period. A referring account may qualify for no more than five referrals, or 50% off, in one billing period. Referral discounts do not carry forward, cannot reduce an invoice below zero, and may be withheld or reversed for duplicate, self, invalid, fraudulent, canceled, refunded, or otherwise ineligible accounts.</p>
      <p><strong>Dashboard estimate:</strong> The dashboard may show the $50 account fee, current counts, unit prices, subtotal, referral savings, and estimated total. Usage can take time to process. Stripe’s finalized invoice, credits, taxes, corrections, disputes, and payment records control the final amount charged.</p>
