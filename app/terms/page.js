...
const sections = [
  ...
  },
  {
    ...
    body: <>
      ...
      <p><strong>Calls:</strong> $2 USD for each connected AI receptionist call during the billing period. A connected call is counted once when it ends. If that same call saves a lead into Contacted You, the saved lead is not a second charge.</p>
      <p><strong>Messages:</strong> When the owner enables Messages, $1 USD is charged when each new chat is created. After that, $1 USD is charged for every 50 SMS parts sent or received during the billing period. Inbound and outbound parts are combined. Long messages may use more than one SMS part.</p>
      ...
      <p><strong>Recorded usage:</strong> Deleting a call, chat, message, lead, client, or employee record does not remove call, chat, SMS-part, or active-employee usage already incurred during the billing period.</p>
      <p><strong>No included allowance:</strong> The account does not include free calls, chats, SMS parts, or employee accounts. Usage starts with the first counted unit during each billing period.</p>
      <p><strong>What counts as a call:</strong> A call is counted when it connects to the AI receptionist and ends, whether or not the caller completes an estimate request. The same call is not counted again because it saves, moves, edits, assigns, or deletes a lead. Duplicate records caused solely by a verified system error may be corrected by ARK.</p>
