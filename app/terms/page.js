...
const sections = [
  ...
  },
  {
    ...
    body: <>
      ...
      <p><strong>Usage points:</strong> Each completed receptionist call or other new lead adds two points ($2). A lead saved from the same receptionist call counts once, not twice. When Messages is enabled, each new chat adds one point ($1), and the combined rolling inbound-and-outbound SMS counter adds one point ($1) whenever it completes another 50 parts. Partial SMS-part progress carries forward, and long messages may use more than one SMS part.</p>
