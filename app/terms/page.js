...
const sections = [
  ...
  {
    id: "paid-service",
    title: "Payment method, monthly account, and usage charges",
    body: <>
      <p>During signup, the payment provider securely confirms payment inside the Service. The iOS app uses Apple In-App Purchase; web and other supported platforms use Stripe. After the provider confirms payment, ARK starts the monthly subscription and the initial $50 monthly charge may be collected immediately.</p>
      ...
      <p><strong>Usage points:</strong> Reviewing a lead in Contacted You is free. Accepting the lead adds two points ($2), while declining it adds no points.</p>
      <p><strong>$20 usage threshold:</strong> When usage reaches or exceeds 20 points, Stripe-billed accounts authorize an exact $20 off-session charge. Apple-billed accounts are prompted to confirm a consumable purchase for 20 non-expiring usage credits through Apple; the displayed Apple price may be lower when referral savings apply. Any points above 20 carry into the next interval. For example, a 19-point balance followed by a two-point lead requires one 20-credit interval and leaves one point.</p>
      <p><strong>Recorded usage:</strong> Deleting an accepted client does not remove valid accepted-lead usage already incurred.</p>
      ...
      <p><strong>Payment display:</strong> Settings shows the $50 monthly rate, current usage balance out of $20, referral percentage, and payment provider. Apple’s or Stripe’s payment records control completed purchases and charges.</p>
