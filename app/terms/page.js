...
const sections = [
  ...
  },
  {
    ...
    body: <>
      ...
      <p><strong>Payment display:</strong> Settings shows the $50 monthly rate, current usage balance out of $20, referral percentage, and saved payment method. Stripe’s payment records control completed charges.</p>
  ...
  }] : []),
  {
    ...
    body: <><p><strong>Immediate pause:</strong> When a monthly or $20 usage payment is declined, ARK immediately disables the AI receptionist and new lead intake. The owner may still sign in and update the payment method.</p><p><strong>Seven-day recovery window:</strong> ARK displays “You need to update your payment method,” retries an eligible unpaid charge no more than once per day, and keeps the account paused for up to seven days after the first failure.</p><p><strong>Deletion:</strong> If payment is not completed by the end of the seven-day recovery window, ARK is designed to cancel associated service and permanently delete the account and its active data. Deleted data may not be recoverable.</p><p><strong>Restoration:</strong> When Stripe confirms the required payment, ARK restores the account, receptionist, and connection automatically. Processing delays, disputes, reversals, or provider outages may delay restoration.</p></>,
  },
  {
    id: "cancellation",
    title: "Cancellation and deletion",
    body: <><p>Owners may manage payment and cancellation through the available Stripe billing controls or contact ARK through Help. Charges already incurred during the current billing period remain due unless ARK issues a credit or applicable law requires otherwise.</p><p>Settings includes a typed-confirmation Delete Account control. When completed successfully, it cancels the active subscription and permanently deletes the active account, Contacted You records, Clients{MESSAGES_AVAILABLE ? ", and supported conversation data" : ""}. Deleted active data may not be recoverable.</p><p>Download needed information before deletion. ARK may retain limited billing, transaction, usage, security, fraud-prevention, agreement, audit, backup, or legal records where required or permitted by law.</p></>,
  },
  {
    id: "data-export",
