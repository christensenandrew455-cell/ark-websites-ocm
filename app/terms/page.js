...
const sections = [
  ...
  },
  {
    ...
    body: <>
      ...
      <p><strong>Messages:</strong> When the owner enables Messages, $1 USD is charged for each 50 SMS message parts sent or received during the billing period. Inbound and outbound parts are combined. Long messages may use more than one SMS part.</p>
      ...
      <p><strong>No included allowance:</strong> The account does not include free calls, free SMS-part bundles, or free employee accounts. Usage starts with the first counted unit during each billing period.</p>
