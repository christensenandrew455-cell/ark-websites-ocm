...
const sections = [
  ...
  {
    id: "rewards",
    title: "Feedback, referrals, and free lead credits",
    body: <><p>ARK may award promotional free lead credits for eligible account activity. A first completed feedback submission may receive a one-time thank-you reward. The reward is for candid, useful feedback and does not depend on whether the feedback is positive or negative.</p><p>Owners may share their referral code or link without a sharing limit. Each of the first three referred businesses that completes a paid signup during a calendar month may award five free lead credits to the referring account. Self-referrals, duplicate accounts, canceled or fraudulent signups, and signups without the referral code do not qualify.</p><p>Earned credits remain banked on an active account until used. They have no cash value, are not transferable, and cannot pay an invoice. Credits can be applied in groups of five only after the current plan’s included accepted-lead allowance is exhausted. Once applied to a billing period, unused additional leads expire at that period’s allowance reset.</p></>,
  },
  ...(MESSAGES_AVAILABLE ? [{
    id: "messages",
