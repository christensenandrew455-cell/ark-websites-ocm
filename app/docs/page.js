      ...
      <div className="mx-auto max-w-4xl">
        <header className="mb-4 sm:mb-6">
          <button
            type="button"
            onClick={goBack}
            className="inline-flex items-center gap-2 rounded-xl border border-slate-200 bg-white px-3 py-2 text-xs font-black text-slate-700 shadow-sm hover:bg-slate-100 hover:text-slate-950 sm:text-sm"
          >
          ...
          <p className="mt-2 max-w-2xl text-sm leading-6 text-slate-600 sm:text-base sm:leading-7">
            Use this guide to understand what the app does, where to find things, and how each part works.
          </p>
        </header>
