...
export const TERMS_KNOWLEDGE_SECTIONS = [
  ...
  ["Additional accepted leads", "Extra accepted leads cost $1 each for the current billing period, have no volume discount, expire at reset, and do not roll over."],
  ["Refer & Save", "Refer & Save is a one-time new-account offer for eligible Stripe-billed owners. The owner has 24 hours after account activation for one different business to use the referral code and complete its first paid subscription signup. The offer ends permanently after one qualifying referral or when the 24 hours expire. The reward is a USD credit equal to the referrer’s recurring plan price at qualification, after an active recurring discount, and starts with the next eligible Stripe bill. Apple-billed accounts are not eligible until ARK releases an Apple-compliant in-app offer. Self-referrals, duplicate, late, invalid, unpaid, fraudulent, or reversed signups do not qualify. Rewards have no cash value and cannot be transferred. Feedback has no reward."],
  ["Plan changes", "Stripe owners may schedule a plan for renewal with no charge today or switch now by paying the new plan price. An immediate switch starts a new billing period. Unused leads expire. No refunds. Apple controls App Store plan-change timing and proration."],
  ["Refunds", "No refunds."],
...
export const PRIVACY_KNOWLEDGE_SECTIONS = [
  ...
  ["Information collected", "ARK processes account and business details; customer and lead contact and request details; billing-provider identifiers and plan usage; referral codes, qualification, free-month amount, status, and Stripe customer-balance transaction identifiers; receptionist, call, app, device, notification, support, feedback, security, and legal-acceptance records."],
  ...
  ["How information is used", "ARK uses information to create and verify accounts, operate the receptionist, organize leads and clients, deliver notifications, count accepted leads, process billing and eligible referral credits, provide help and downloads, prevent abuse, secure and improve the service, enforce policies, and meet legal duties."],
  ...
  ["Choices and requests", "The website lets owners change email or text alerts; native apps hide those website controls and use phone notification settings. Owners can also change retention, download supported data, manage payment, or delete the account in Settings. ARK may verify identity and account authority before fulfilling access, correction, privacy, billing, or deletion requests."],
