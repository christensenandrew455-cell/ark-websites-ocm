...
export const TERMS_KNOWLEDGE_SECTIONS = [
  ...
  ["Refer & Save", "A referral qualifies after a different business uses the referrer’s code and completes its first paid subscription signup. Each qualifying referral gives an eligible Stripe-billed referrer a USD credit equal to that referrer’s recurring plan price at qualification, after an active recurring discount. The credit starts with the next eligible Stripe bill; excess credit remains for later eligible Stripe bills. There is no three-referral monthly cap. Apple-billed accounts are not eligible until ARK releases an Apple-compliant in-app offer. Self-referrals, duplicate, invalid, unpaid, fraudulent, or reversed signups do not qualify. Rewards have no cash value and cannot be transferred. Feedback has no reward."],
