...
export const HELP_SECTIONS = [
  ...
  },
  {
    ...
    points: [
      ...
      "When Messages is enabled, combined inbound and outbound SMS usage is $1 per 50 SMS parts.",
      "When Employees is enabled, each approved active employee used during the billing period is $5.",
