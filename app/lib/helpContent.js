...
export const HELP_SECTIONS = [
  {
    ...
    points: [
      "Dashboard shows the ARK receptionist number and shortcuts to Leads, Free Leads, and Settings.",
      ...
      "Settings contains Business information, App, Plan and payment, and Help & Account.",
  ...
  },
  {
    ...
    links: ["Settings", "Free Leads", "Payment Terms"],
  },
  {
    id: "payment",
  ...
  },
  {
    ...
    summary: "App controls appearance, alerts, customer updates, automatic record deletion, and data download.",
    points: [
  ...
  ...(MESSAGES_AVAILABLE ? [{
    ...
    points: [
      "Turn Messages on or off in App. All conversations must be deleted before the feature can be turned off.",
  ...
  {
    id: "rewards",
    title: "Free leads and referrals",
    summary: "Free Leads holds credits earned from eligible feedback and referrals.",
    points: [
    ...
    links: ["Free Leads", ...(TEMPORARY_FEATURES.feedback.enabled ? ["Give Feedback"] : []), "Settings"],
  },
  {
    id: "data-account-help",
    title: "Data, account, and help",
    summary: "App contains data download. Help & Account contains Docs, AI Chat, Support, legal policies, and account deletion.",
    points: [
      ...
      "In Settings → App → Your data, Download data saves the supported current account, lead, client, and Help data in a JSON file while the account has access.",
