...
const ALL_HELP_LINKS = [
  ...
  { label: "Account Data", href: "/settings?section=customization#account-data" },
...
export const HELP_SECTIONS = [
  {
    ...
    points: [
      "Dashboard shows the ARK receptionist number and shortcuts to Leads, Rewards, and Settings.",
      ...
      "Settings contains Business information, App and alerts, Plan and payment, and Help & Account.",
  ...
  },
  {
    ...
    points: [
      "Regular scheduling uses the business time zone, service days, earliest time, and latest time.",
      ...
      "Turn on Emergency requests only when the business accepts urgent or ASAP work. Regular requests remain available.",
      "Available 24/7 lets emergency requests arrive outside the regular schedule. When it is off, emergency requests use the regular schedule.",
  ...
  },
  {
    ...
    points: [
      ...
      "Banked free lead credits can be applied in groups of five after the included monthly limit reaches zero.",
      "When no accepted leads remain, change the plan, buy extra leads, apply eligible free leads, or wait for the reset.",
    ],
    links: ["Settings", "Rewards", "Payment Terms"],
  },
  {
    id: "payment",
    title: "Payment and plan changes",
    summary: "Settings → Payment shows the current plan, leads left, reset date, payment method, and billing status.",
    points: [
      "Manage plan and payment opens plan choices, extra leads, free lead use, and payment-card controls.",
  ...
  },
  {
    ...
    title: "Alerts, texts, and auto-delete",
    summary: "App and alerts controls alert delivery, customer decision texts, and automatic record deletion.",
    points: [
      "Choose email alerts, text alerts, or both. At least one delivery method must stay selected.",
  ...
  ...(MESSAGES_AVAILABLE ? [{
    ...
    points: [
      "Turn Messages on or off in App and alerts. All conversations must be deleted before the feature can be turned off.",
  ...
  }] : []),
  {
    ...
    summary: "Rewards holds free lead credits earned from eligible feedback and referrals.",
    points: [
      "The first thoughtful feedback submission may earn a one-time reward. The opinion can be positive, neutral, or negative.",
      ...
      "Each of the first three completed paid referrals in a calendar month earns five free lead credits. The referral link can be shared more than three times.",
      "Credits stay banked on the active account, have no cash value, and cannot pay an invoice.",
    ],
    links: ["Rewards", ...(TEMPORARY_FEATURES.feedback.enabled ? ["Give Feedback"] : []), "Settings"],
  },
  {
    id: "data-account-help",
    title: "Data, account, and help",
    summary: "Help & Account contains Docs, AI Chat, Support, legal policies, data download, and account deletion.",
    points: [
      ...
      "Download Client Data saves the supported current account, lead, client, and Help data in a JSON file while the account has access.",
    ...
    links: ["Help & Account", "AI Chat", "Support", "Account Data", "Terms of Use", "Privacy Policy"],
  },
];
