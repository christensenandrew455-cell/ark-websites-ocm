  ...
  return (
    <main className="grid min-h-screen place-items-center bg-slate-950 p-5">
      <div className="w-full max-w-md rounded-3xl bg-white p-7 shadow-2xl md:p-9">
        ...
        <p className="mt-2 text-sm text-slate-600">Sign in with your business name or account email.</p>

        <form onSubmit={handleSubmit} className="mt-7 space-y-4">
          <label className="block">
            <span className="text-sm font-semibold text-slate-700">Business name or account email</span>
            <input
              required
