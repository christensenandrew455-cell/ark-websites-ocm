      ...
      <div className="mx-auto max-w-4xl">
        ...
        {!setupMode && (
          <>
            ...
            <Link href="/messages" className="mt-4 block rounded-2xl border border-slate-200 bg-white p-4 shadow-sm sm:mt-6 sm:p-6"><p className="text-[10px] font-black uppercase tracking-[0.18em] text-slate-500">Contact ARK</p><h2 className="mt-1 text-lg font-black sm:text-2xl">Help</h2><p className="mt-2 text-xs leading-5 text-slate-500 sm:text-sm">Submit any issue or question you need help with, including technical problems or an account-deletion request.</p><span className="mt-4 inline-flex rounded-xl bg-slate-950 px-5 py-3 text-sm font-black text-white">Request Help</span></Link>
