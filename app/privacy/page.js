...
const sections = [
  { title: "What this policy covers", body: <p>This Privacy Policy explains how ARK Websites collects, uses, stores, discloses, exports, and deletes information through ARK Client Center and its related AI receptionist, lead-management{MESSAGES_AVAILABLE ? ", optional messaging" : ""}, support, website, and billing services.</p> },
  {
    ...
    body: <>
      <p><strong>Account and business information:</strong> business name and normalized business identifier, owner name, email address, phone number, account identifier, account status, feature settings, connection details, selected call plan, identity-verification status, and payment-restriction status.</p>
      ...
      <p><strong>Billing and call-plan information:</strong> Apple account-token, product, subscription, original-transaction, transaction, expiration, environment, and notification identifiers; Stripe Customer, SetupIntent, PaymentMethod, subscription, PaymentIntent, invoice, coupon, and payment-event identifiers; selected plan, promotion and sales channel, regular and discounted monthly price, monthly call allowance, calls used and remaining, billing-period dates, last successful payment time, and payment-retry and deletion deadlines. Apple or Stripe controls sensitive payment details, and ARK does not receive or store full card numbers, expiration values, security codes, or Apple Account credentials.</p>
  ...
  },
  {
    ...
    body: <>
      <p>ARK uses information to create and manage business accounts; verify email addresses and phone numbers; prevent duplicate business identities; enable or disable optional features; receive, organize, store, and display leads; operate receptionist{MESSAGES_AVAILABLE ? " and messaging" : ""} features; deliver notifications; count completed calls against the selected monthly plan; process subscription billing; receive and review feedback; provide support and downloads; test, maintain, secure, and improve the Service; prevent fraud or abuse; enforce account policies; and comply with legal obligations.</p>
      ...
      <p>Apple or Stripe payment events may be used to activate and renew the selected monthly call plan, confirm the plan and billing period, show payment notices, pause paid services after a subscription failure, restore service, or delete a payment-restricted account after the seven-day recovery window.</p>
    </>,
  },
  {
    title: "Payment setup",
