...
const sections = [
  { title: "1. What this policy covers", body: <p>This Privacy Policy explains how ARK Websites collects, uses, stores, discloses, exports, and deletes information through ARK Client Center and its related AI receptionist, lead-management, optional employee, optional messaging, support, website, and billing services.</p> },
  {
    ...
    body: <>
      <p><strong>Account and business information:</strong> business name and normalized business identifier, owner or employee name, email address, phone number, account identifier, optional referring-account identifier, owner or employee role, account and approval status, feature settings, connection details, usage information, and payment-restriction status.</p>
      ...
      <p><strong>Billing and usage information:</strong> Stripe customer, payment-method, subscription, meter, coupon, charge, invoice, payment-event, amount-due, billing-status, referral-qualification, and payment-incident identifiers; $2 new-lead event totals; $1 new-chat totals; rolling SMS message-part totals billed when each additional 50 parts is completed; $5 active-employee totals; and referral discounts. ARK does not receive or store full card numbers; Stripe handles full card details.</p>
      <p><strong>Service and technical information:</strong> receptionist, AI, phone, messaging, and app usage records, SMS-part counts, delivery status, provider message identifiers, timestamps, device or browser information, notification tokens, unread-message or unread-lead counts, error logs, security events, and information needed to operate connected providers.</p>
  ...
  },
  {
    ...
    body: <>
      <p>ARK uses information to create and manage owner and employee accounts; validate and qualify referrals; prevent duplicate business identities; enable or disable optional features; approve or restrict employee access; receive, organize, store, display, and assign leads; operate receptionist and messaging features; deliver notifications; calculate $50 monthly account billing, usage charges, and referral savings; provide support and downloads; test, maintain, secure, and improve the Service; prevent fraud or abuse; enforce account policies; and comply with legal obligations.</p>
      ...
      <p>Stripe payment and usage events may be used automatically to calculate billing estimates, record call, chat, SMS-part, and active-employee usage, show payment notices, restrict owner or employee access, and place an unpaid account into manual review.</p>
    </>,
  },
  {
  ...
  },
  {
    ...
    body: <>
      <p>When Messages is enabled, outbound and inbound messaging providers may receive phone numbers, message content, lead and conversation identifiers, SMS-part counts, and delivery information needed to send or receive messages.</p>
  ...
  { title: "8. Sale of information", body: <p>ARK does not sell customer, lead, owner, or employee information for money. ARK does not use that information for unrelated third-party advertising.</p> },
  {
    ...
    body: <>
      <p>ARK generally retains owner, employee, assignment, customer, and conversation data while the account is active and as needed to provide the Service. Owners may separately choose Never, 1 day, 1 week, or 1 month auto-delete settings for Leads and Messages.</p>
  ...
  { title: "10. Security", body: <p>ARK uses reasonable administrative, technical, and organizational safeguards designed to protect information. Employee access is filtered by account status, feature settings, assignment, and owner visibility settings. No internet, phone, cloud, messaging, or storage system can guarantee absolute security, so users should protect credentials, avoid sharing accounts, limit access, secure downloaded files, and notify ARK or the owner promptly of suspected misuse.</p> },
  {
    ...
    body: <>
      <p>While an owner account has full access, the owner may turn optional features on or off, choose Leads and Messages auto-delete settings, use Download Client Data, update payment information through Stripe, or permanently delete the account through Settings. Employees can ask the owner to correct employee details, assignments, or access settings.</p>
  ...
  { title: "13. Children", body: <p>The Service is intended for businesses and authorized adult users. It is not designed for children to create owner or employee accounts or submit personal information directly.</p> },
  {
    ...
    body: <><p>ARK may update this Privacy Policy as the Service, pricing, employee features, providers, or legal requirements change. The version and effective date appear at the top of this page. ARK may request renewed acceptance when a material change requires it.</p><p>Owners can use Settings, Help, and Send a Message for account-specific privacy, access, correction, or billing requests. Employees should contact the owner for employee-access or assignment questions.</p></>,
  },
];
