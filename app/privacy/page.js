...
const sections = [
  { title: "What this policy covers", body: <p>This Privacy Policy explains how ARK Websites collects, uses, stores, discloses, exports, and deletes information through ARK Client Center and its related AI receptionist, lead-management{MESSAGES_AVAILABLE ? ", optional messaging" : ""}, support, website, and billing services.</p> },
  {
    ...
    body: <>
      ...
      <p><strong>Billing and accepted-lead plan information:</strong> Apple account-token, product, subscription, original-transaction, transaction, purchase-quantity, expiration, environment, and notification identifiers; Stripe Customer, SetupIntent, PaymentMethod, subscription, schedule, PaymentIntent, invoice, coupon, and payment-event identifiers; selected and pending plan, plan-change timing, promotion and sales channel, regular and discounted monthly price, monthly accepted-lead allowance, top-up quantity and payment receipt, accepted leads used and remaining, billing-period dates, last successful payment time, and payment-retry and deletion deadlines. Apple or Stripe controls sensitive payment details, and ARK does not receive or store full card numbers, expiration values, security codes, or Apple Account credentials.</p>
  ...
  },
  {
    ...
    body: <>
      ...
      <p>Apple or Stripe payment events may be used to activate, change, and renew the selected monthly accepted-lead plan; confirm a top-up purchase; reset the billing-period allowance without rollover; show payment notices; pause paid services after a subscription failure; restore service; or delete a payment-restricted account after the seven-day recovery window.</p>
    </>,
  },
  {
    title: "Payment setup",
