...
const sections = [
  { title: "What this policy covers", body: <p>This Privacy Policy explains how ARK Websites collects, uses, stores, discloses, exports, and deletes information through ARK Client Center and its related AI receptionist, lead-management{MESSAGES_AVAILABLE ? ", optional messaging" : ""}, support, website, and billing services.</p> },
  {
    ...
    body: <>
      ...
      <p><strong>Billing and call-plan information:</strong> Apple account-token, product, subscription, original-transaction, transaction, expiration, environment, and notification identifiers; Stripe Customer, SetupIntent, PaymentMethod, subscription, PaymentIntent, invoice, and payment-event identifiers; selected plan, monthly call allowance, calls used and remaining, billing-period dates, last successful payment time, and payment-retry and deletion deadlines. Apple or Stripe controls sensitive payment details, and ARK does not receive or store full card numbers, expiration values, security codes, or Apple Account credentials.</p>
  ...
  },
  {
    ...
    body: <>
      <p>ARK uses information to create and manage business accounts; verify email addresses and phone numbers; prevent duplicate business identities; enable or disable optional features; receive, organize, store, and display leads; operate receptionist{MESSAGES_AVAILABLE ? " and messaging" : ""} features; deliver notifications; count completed calls against the selected monthly plan; process subscription billing; provide support and downloads; test, maintain, secure, and improve the Service; prevent fraud or abuse; enforce account policies; and comply with legal obligations.</p>
