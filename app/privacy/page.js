...
const sections = [
  ...
  },
  {
    ...
    body: (
      <>
        <p><strong>Account and business information:</strong> business name, owner or contact name, email address, phone number, account identifier, account status, current and pending receptionist plan, billing status, settings, connection details, usage information, and payment-restriction status.</p>
        ...
        <p><strong>Call-usage and recommendation information:</strong> call identifiers or hashed identifiers, timestamps, duration, call outcome, whether a lead was saved, whether the call counted as a completed billable call, monthly call totals, included calls remaining, overage calls, overage amount, prior-month usage, and plan recommendations generated from that usage.</p>
        <p><strong>Billing information:</strong> Stripe customer, payment-method label, subscription, plan-price, metered-call, charge, invoice, payment-event, amount-due, billing-status, and payment-incident identifiers. A payment-method label may include the card brand and last four digits. ARK does not receive or store the full card number; full card details are handled by Stripe.</p>
  ...
  },
  {
    ...
    body: (
      <>
        <p>ARK uses information to create and manage accounts; receive, organize, store, and display leads; operate receptionist and communication features; deliver notifications; process and reconcile monthly plan and completed-call overage billing; measure usage; calculate calls remaining and overage; generate next-month plan choices; provide support; prepare customer-requested downloads; test, maintain, secure, and improve the Service; prevent fraud or abuse; enforce account policies; and comply with legal obligations.</p>
        ...
        <p>Prior-month completed-call totals may be processed automatically to compare available pricing plans and present a lower-monthly option, a recommended option, and an option with more included calls or lower overage. A recommendation is not an automatic plan change.</p>
        <p>Stripe payment events may be used automatically to show the current monthly amount due, record completed-call overage, show payment notices, place an account in or remove it from payment-restricted mode, and place an unpaid account into manual deletion review. Permanent deletion remains a separate administrator action.</p>
      </>
    ),
  },
  {
    ...
    body: (
      <>
        ...
        <p>Authorized ARK administrators can access the business name, owner and contact details, account email and phone, account and connection status, Contacted Me records, accepted Client records, requested services, appointment details, messages, notes, Help-message history, call-usage records, current and pending plan, calls used and remaining, overage calls and amount, payment-method label, subscription status, amount-due and payment-incident information, policy-acceptance records, notification status, and technical or security information when needed to operate, maintain, test, secure, troubleshoot, support, bill, enforce, or administer the Service. This means ARK can see customer and lead data stored in the Service.</p>
  ...
  },
  {
    ...
    body: (
      <>
        ...
        <p>Limited backup, billing, transaction, Stripe-event, call-usage, security, fraud-prevention, agreement, audit, or legal records may remain for a reasonable period where required or permitted by law, even after active account and client data is deleted. Backup copies may remain until normal backup rotation completes.</p>
      </>
    ),
  },
  {
  ...
  },
  {
    ...
    body: (
      <>
        ...
        <p>The Dashboard allows an authorized account user to select a recommended receptionist plan for a future month. Plan selections and billing questions may also be addressed through Help. ARK may need to verify identity and account authority before completing a request.</p>
        <p>During payment-restricted mode, the account may be limited to receiving and accepting leads; restore payment first to regain Settings, signed-in Help messages, and download features.</p>
