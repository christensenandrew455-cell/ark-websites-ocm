    ...
    <div className="mx-auto max-w-5xl px-4 py-8 sm:px-6 sm:py-12">
      ...
      <section className="mt-6 rounded-3xl border border-slate-200 bg-white p-6 shadow-sm sm:p-8">
        ...
        <div className="mt-4 grid gap-4 sm:grid-cols-3">
          ...
          <div className="rounded-2xl bg-indigo-950 p-5 text-white"><h3 className="text-xl font-black">Chats · $1 each, then $1 per 50 parts</h3><p className="mt-2 text-sm leading-6 text-indigo-100">A chat is charged only when it is created. Inbound and outbound parts share a rolling counter, and unfinished progress carries into the next period.</p></div>
