...
export default function AboutPage() {
  return <main className="min-h-screen bg-transparent text-slate-950">
    ...
    <div className="mx-auto max-w-5xl px-4 py-8 sm:px-6 sm:py-12">
      ...
      <section className="mt-6 rounded-3xl border border-slate-200 bg-white p-6 shadow-sm sm:p-8"><h2 className="text-2xl font-black">Payment and privacy</h2><p className="mt-3 text-sm leading-6 text-slate-600">During signup, Stripe securely collects and saves the payment method inside ARK without charging it on that screen. ARK does not receive or store full card numbers. Recurring and usage billing occurs separately under the Terms of Use.</p></section>
    </div>
  </main>;
}
