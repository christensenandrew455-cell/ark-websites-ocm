  ...
  return (
    <main className="grid min-h-screen place-items-center bg-slate-950 p-5 py-10">
      <section className="w-full max-w-xl rounded-3xl bg-white p-7 shadow-2xl sm:p-9">
        ...
        <p className="mt-5 text-[10px] font-black uppercase tracking-[0.2em] text-indigo-700">Step 2 of 2 · Payment setup</p>
        <div className="mt-3 inline-flex rounded-full bg-green-100 px-3 py-1 text-[10px] font-black uppercase text-green-800">Account created</div>
        ...
        <div className="mt-4 rounded-2xl border border-slate-200 bg-slate-50 p-4 text-sm leading-6 text-slate-700"><p><strong>ARK AI Receptionist</strong></p><p className="mt-1">{BILLING_SUMMARY}</p><p className="mt-1">Qualified referrals save 10% each for one billing period, up to 50%. Stripe securely stores the payment method and processes recurring and usage-based invoices.</p></div>
