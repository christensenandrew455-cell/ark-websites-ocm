    ...
    <main className="ark-auth-page min-h-screen px-5 pb-[calc(env(safe-area-inset-bottom)+5rem)] pt-10">
      <div className="ark-auth-card mx-auto w-full max-w-3xl rounded-3xl p-7 shadow-2xl md:p-9">
        ...
        <form onSubmit={handleSubmit} className="mt-7 grid gap-4 md:grid-cols-2">
          ...
          <label className="block md:col-span-2"><span className="text-sm font-semibold text-slate-700">Referral code <span className="font-medium text-slate-400">(optional)</span></span><input name="referralCode" autoCapitalize="none" autoCorrect="off" value={form.referralCode} onChange={updateField} placeholder="Business referral code" className="mt-2 w-full rounded-xl border border-slate-300 px-4 py-3 outline-none focus:border-slate-950" /></label>
