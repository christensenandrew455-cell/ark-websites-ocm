...
<vector xmlns:android="http://schemas.android.com/apk/res/android"
    ...
    <!-- Large ARK word, centered inside Android's adaptive-icon safe zone. -->
    <group
    ...
    <!-- Tiny CLIENT CENTER wordmark on one centered line. -->
    <group
        android:translateX="19.35"
        ...
        <path
            ...
            android:strokeLineCap="round"
            android:strokeLineJoin="round" />
        <group android:translateX="61" android:translateY="-17">
            <path
...
console.log("[Android configuration] Centered ARK Client Center launcher icon applied.");
