...
The current Android test build loads ARK Client Center at `https://ark-websites-ocm-xi.vercel.app` so the live login, Firebase data, and Next.js API routes continue to work while the native shell is tested on a physical phone.
